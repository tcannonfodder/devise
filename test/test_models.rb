...
class Configurable < User
  devise :database_password_authenticatable, :confirmable, :rememberable, :timeoutable, :lockable,
         stretches: 15, pepper: 'abcdef', allow_unconfirmed_access_for: 5.days,
         remember_for: 7.days, timeout_in: 15.minutes, unlock_in: 10.days
end

class WithValidation < Admin
  devise :database_password_authenticatable, :password_validatable, password_length: 2..6
end
