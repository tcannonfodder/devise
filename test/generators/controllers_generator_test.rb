...
class ControllersGeneratorTest < Rails::Generators::TestCase
  ...
  test "Assert no controllers are created with no params" do
    ...
    assert_no_file "app/controllers/password_registrations_controller.rb"
  ...
  test "Assert specified controllers with scope" do
    ...
    assert_no_file "app/controllers/users/password_registrations_controller.rb"
  ...
  private
    ...
    def assert_class_names(scope, options = {})
      ...
      controllers = options[:controllers] ||
        %w(confirmations passwords password_registrations sessions unlocks omniauth_callbacks)
